...
<body>
    ...
    <dialog class="md3-dialog" id="invalid-credentials">
        ...
        <div class="md3-dialog__text">
            <span>El correo no está registrado como administrador.</span>
        </div>
    ...
    <main>
        <div id="container">
            ...
            <section>
                <div>
                    <h4>Admin ACME</h4>
                    <p>Escriba su correo electrónico para ingresar a su cuenta.</p>
                </div>
                <form method="POST" id="admin-form">
                    <input class="md3-input--text" type="email" name="email" placeholder="admin@acme.com" required />
